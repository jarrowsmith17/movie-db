  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-black mb-10 tracking-tighter">Request Manager</h1>
          <Link href="/admin" className="text-zinc-500 hover:text-white transition mb-10text-sm flex items-center gap-1">
              ← Back to Dashboard
            </Link>
